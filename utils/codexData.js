...
const COMANDOS = [
  ...
  },
  {
    ...
    emoji: '⚙️',
    descricao: 'Define onde a bot fala, canais de anúncio, shutdown, tickets e on/off (requer Gerir Servidor).',
    uso: '$configurar ver | permitir | proibir | shutdown #canal | ticketcategoria #categoria | off-on #canal',
    exemplo: 'Controla canais, roteamento de anúncios, avisos de desligamento, tickets e notificações online/offline.',
  },
  {
    nome: 'anuncio',
    categoria: 'organizacao',
  ...
  },
  {
    ...
    categoria: 'organizacao',
    emoji: '🎪',
    descricao: 'Sistema de tickets com tema de circo. Cria canais privados de atendimento.',
    uso: '$ticket  •  $ticket config #categoria  •  $ticket staff add @cargo',
  ...
  },
  {
    ...
    categoria: 'admin',
    emoji: '🔒',
    descricao: 'Fecha o ticket do canal atual. O canal é removido após 10 segundos.',
    uso: '$fechar',
    exemplo: 'Funciona apenas em canais de ticket (que começam com ticket-).',
  },
  {
    nome: 'codex',
    categoria: 'organizacao',
